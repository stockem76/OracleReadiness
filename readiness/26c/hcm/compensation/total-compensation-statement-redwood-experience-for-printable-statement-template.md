...
# Total Compensation Statement: Redwood Experience for Printable Statement Template

`🔧 Optional Uptake` · `⚙️ Steps to Enable`

> 📖 [View on Oracle Help Center](https://docs.oracle.com/en/cloud/saas/readiness/hcm/26c/comp-26c/26C-compensation-wn-f49864.htm)

Check out the new Printable Statement Template page re-created with the Redwood tool set Visual Builder Studio (VBS). You can enable the page along with the Redwood experience.
