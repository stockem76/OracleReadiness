[📋 26C](https://github.com/stockem76/OracleReadiness/blob/main/readiness/26c/index.md) › [HCM](https://github.com/stockem76/OracleReadiness/blob/main/readiness/26c/hcm/index.md) › [Oracle Me Employee Experience](https://github.com/stockem76/OracleReadiness/blob/main/readiness/26c/hcm/oracle-me-employee-experience.md)

# Personalized Learning Guidance Using Grow Coach

`⚙️ Steps to Enable` · `💡 Tips & Considerations` · `🔐 Access Requirements`

> 📖 [View on Oracle Help Center](https://docs.oracle.com/en/cloud/saas/readiness/hcm/26c/meex-26c/26C-employee-experience-wn-f49341.htm)
...
• Grow Coach provides the best experience when Grow is enabled and recommendations are available on the Grow page. The more relevant recommendations available, the more effectively Grow Coach can assist you.
...
---
*Oracle Cloud Readiness · 26C · HCM · Oracle Me Employee Experience*