...
1. To use these capabilities, first enable Touchless Expenses as outlined in the Touchless Mobile Expenses (25D) feature.
2. Configure cash advance application settings for the applicable business units.  
...
• Employees can use the Expenses Agent to apply multiple cash advances to an expense report.
• Cash advances are applied at the expense report level, not at the individual expense line level.
• When a report is rejected, returned, or withdrawn, the applied cash advance is removed, the applied amount is credited back to the cash advance, and the due date remains unchanged.
